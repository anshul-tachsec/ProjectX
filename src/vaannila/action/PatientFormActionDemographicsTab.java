...
public class PatientFormActionDemographicsTab extends ActionSupport implements SessionAware{ 
	...
	public PatientFormActionDemographicsTab()
	{
	...
	public String execute() throws Exception{
		System.out.println("In PatientFormAction demographicstab");

		System.out.println("username via session"+m.get("username"));	
		System.out.println("domain via session"+m.get("domain"));

		LoginDAO.patientEntryDemographicsTab(patientFormBean , m );
