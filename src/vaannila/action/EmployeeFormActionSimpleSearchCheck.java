...
public class EmployeeFormActionSimpleSearchCheck extends ActionSupport implements SessionAware{
	...
	public String execute()throws Exception
	{
		...
		try{
			...
			String check1="SELECT * FROM employee WHERE (username = '"+employeeFormSearch.getUsername()+"'";
			String check2;
			String check3;
			String check4;
			String check5;
