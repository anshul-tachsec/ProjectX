					...
					<tr>
						<td width="50%">
							<table width="100%" border="0" cellspacing="0" cellpadding="1">
								...
								<tr></tr>
								<tr>
									<td><span style="color: Red">Demographics</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.treatingProvider" tabindex="2" size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.residentialState" tabindex="2" size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="patientFormBean.patientEmail"
										tabindex="2" size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									<td width="15%">Date</td>
									<td><input type="text"
										name="patientFormBean.confidentialDate" tabindex="2" size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="patientFormBean.consentNotes"
										tabindex="2" size="25"></td>
								</tr>
							</table>
						<td width="50%">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="1"
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.primaryPolicyProviderName" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.secondaryInsurance" tabindex="2" size="25"></td>
								</tr>
								<tr>
									<td width="15%">Secondary Insurance Provider</td>
									<td><input type="text"
										name="patientFormBean.secondaryInsuranceProvider" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
									<td width="15%">Secondary Insurance ID No.</td>
									<td><input type="text"
										name="patientFormBean.secondaryInsuranceIdNumber" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.tertiaryProvider" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
									<td width="15%">Tertiary Insurance Provider</td>
									<td><input type="text"
										name="patientFormBean.tertiaryInsuranceProvider" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
									<td width="15%">Tertiary Insurance ID No.</td>
									<td><input type="text"
										name="patientFormBean.tertiaryInsuranceIdNumber" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.tertiaryPolicyProviderName" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.patientCoPay" tabindex="2"
										size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text"
										name="patientFormBean.paymentNotes" tabindex="2"
										size="25"></td>
								</tr>
								
								<tr>
									<td width="15%">Patient Picture/Photo</td>
									<td><input type="text" name="patientFormBean.patientPhoto"
										tabindex="3" size="25"></td>
								</tr>
								<tr>
									<td><span style="color: Red">Additional Information</span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="patientFormBean.facilityName"
										tabindex="2" size="25"></td>
								</tr>
								<tr>
									<td width="15%">Email Consent</td>
									<td><input type="text" name="patientFormBean.emailConsent"
										tabindex="2" size="25"></td>
								</tr>
								<tr>
								...
								<tr>
									<td width="15%">Additional Notes</td>
									<td><input type="text"
										name="patientFormBean.additionalInformationNotes" tabindex="2"
										size="25"></td>
								</tr>

								<tr>
									<s:submit value="Submit" tabindex="3" />
								</tr>
							</table>
						</td>
					</tr>
