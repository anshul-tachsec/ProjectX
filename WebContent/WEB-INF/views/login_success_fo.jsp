											...
											<td width="50%">
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><input type="text"
															name="patientFormSearch.gender" tabindex="2" size="25"></td>
													</tr>
													...
													<tr>
														<td width="25%">D.O.B.</td>
														<td><input type="text"
															name="patientFormSearch.patientDOB" tabindex="2"
															size="25"></td>
													</tr>
													<tr>
														<td width="25%">Race</td>
													...
													<tr>
														<td width="25%">SSN</td>
														<td><input type="text"
															name="patientFormSearch.patientSSN" tabindex="2"
															size="25"></td>
													</tr>
													<tr>
														<td width="25%">D.O.O.</td>
														<td><input type="text"
															name="patientFormSearch.patientDOO" tabindex="2"
															size="25"></td>
													</tr>
												</table>
												<td width="50%">
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.mailStreet" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.mailState" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.homePhone" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
															<td width="25%">Work Phone</td>
															<td><input type="text"
																name="patientFormSearch.workPhone" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
															<td width="25%">Cell Phone</td>
															<td><input type="text"
																name="patientFormSearch.cellPhone" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
															<td width="25%">Email</td>
											...
											<td width="50%">
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><input type="text"
															name="patientFormSearch.primaryGroupIdNumber"
															tabindex="2" size="25"></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><input type="text"
															name="patientFormSearch.secondaryProviderDOB"
															tabindex="2" size="25"></td>
													</tr>
												</table>
												<td width="50%">
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.tertiaryProviderDOB"
																tabindex="2" size="25"></td>
														</tr>
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.insurancePhoneNumber"
																tabindex="2" size="25"></td>
														</tr>
														<tr>
												...
												<table cellspacing="0" cellpadding="1" align="left">
													<tr>
														...
														<tr>
															...
															<td><input type="text"
																name="patientFormSearch.onsetDate" tabindex="2"
																size="25"></td>
														</tr>
														<tr>
